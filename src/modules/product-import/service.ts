 ...
 * или Amazon.
 *
 * Данные приходят двумя путями. Расширение для Chrome снимает их прямо со
 * страницы и присылает уже разобранными: название, описание и настоящие SKU
 * продавца. Тогда модель ничего не выдумывает — только переводит текст и
 * названия вариантов, а структуру опций мы берём как есть. Если же продавец
 * вставил текст руками на странице импорта, вариантов в нём нет, и модель
 * восстанавливает их по описанию как раньше.
 *
