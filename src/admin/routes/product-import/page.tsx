...
/**
 * Страница импорта товара.
 *
 * Страницы Taobao, Amazon и Alibaba закрыты антибот-защитой, поэтому текст
 * и ссылки на фото продавец копирует руками. Всё остальное — перенос медиа
 * в наше хранилище, описание и варианты — делает бэкенд.
 */
    ...
    <Container className="divide-y p-0">
      ...
      <div className="px-6 py-4">
        <Text className="text-ui-fg-subtle" size="small">
          Откройте страницу товара на Taobao, Amazon или Alibaba, скопируйте
          описание и ссылки на изображения и вставьте их сюда. Товар будет
          создан черновиком: фото и видео перенесутся в наше хранилище,
          описание и варианты сгенерируются на русском. Цены проставьте сами
          перед публикацией.
        </Text>
      </div>
